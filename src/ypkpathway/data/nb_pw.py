...
# (single gene expression cassettes) into a pathway.
#
...
rp_last = p['{rp_last}']
# %%
first_template_vector, *middle_template_vectors, last_template_vector = template_vectors
# %%
cassette_pcr_products.append(pcr(fp_first, rp, first_template_vector))
...
cassette_pcr_products.extend(pcr(fp, rp, v)
                             for v in middle_template_vectors)

# %% [markdown]
# The last cassette in the pathway.

# %%
cassette_pcr_products.append(pcr(fp, rp_last, last_template_vector))

# %% [markdown]
# The cassette pcr products are named using the tu cassette vector file names.
