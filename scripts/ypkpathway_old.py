...
re_pname = re.compile(r"(?P<primernumber>\d+)(_(?P<primername>.+)|)")
...
def pYPKa_ZE_from_csv( text           : str,
    ...
    for insert,gblink,f,r in info:
        ...
        if f and r:
            ...
            fp = list_primers[int(re_pname.match(f).group("primernumber"))]
            rp = list_primers[int(re_pname.match(r).group("primernumber"))]
